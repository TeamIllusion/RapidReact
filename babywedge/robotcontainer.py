...
from commands.cartesiandrive import CartesianDrive
...
class RobotContainer:
    ...
    def _configureButtonBindings(self):
        ...
        # Default command is killough drive. This will run unless another command
        # is scheduler over it
        self.drivetrain.setDefaultCommand(self.getCartesianDriveCommand())
    ...
    def getCartesianDriveCommand(self) -> CartesianDrive:
